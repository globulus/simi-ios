...
inline NSString *SMActiveSimi_get_FILE_ACTIVE_SIMI(void);
static NSString *SMActiveSimi_FILE_ACTIVE_SIMI = @"ActiveSimi";
J2OBJC_STATIC_FIELD_OBJ_FINAL(SMActiveSimi, FILE_ACTIVE_SIMI, NSString *)
...
inline SMDebugger *SMActiveSimi_get_debugger(void);
inline SMDebugger *SMActiveSimi_set_debugger(SMDebugger *value);
static SMDebugger *SMActiveSimi_debugger;
J2OBJC_STATIC_FIELD_OBJ(SMActiveSimi, debugger, SMDebugger *)
...
inline id<JavaUtilList> SMActiveSimi_get_resolvedImports(void);
inline id<JavaUtilList> SMActiveSimi_set_resolvedImports(id<JavaUtilList> value);
static id<JavaUtilList> SMActiveSimi_resolvedImports;
J2OBJC_STATIC_FIELD_OBJ(SMActiveSimi, resolvedImports, id<JavaUtilList>)
...
__attribute__((unused)) static void SMActiveSimi_runWithNSString_withBoolean_(NSString *source, jboolean isLoad);

__attribute__((unused)) static id<SMSimiProperty> SMActiveSimi_runExpressionWithNSString_(NSString *expression);

__attribute__((unused)) static id<JavaUtilList> SMActiveSimi_scanImportsWithJavaUtilList_withJavaUtilMap_(id<JavaUtilList> input, id<JavaUtilMap> nativeModulesManagers);
...
withSMDebugger_DebuggerInterface:(id<SMDebugger_DebuggerInterface>)debuggerInterface {
  SMActiveSimi_setDebugModeWithBoolean_withSMDebugger_DebuggerInterface_(debug, debuggerInterface);
}
...
+ (void)runWithNSString:(NSString *)source
            withBoolean:(jboolean)isLoad {
  SMActiveSimi_runWithNSString_withBoolean_(source, isLoad);
}
...
+ (id<JavaUtilList>)scanImportsWithJavaUtilList:(id<JavaUtilList>)input
                                withJavaUtilMap:(id<JavaUtilMap>)nativeModulesManagers {
  return SMActiveSimi_scanImportsWithJavaUtilList_withJavaUtilMap_(input, nativeModulesManagers);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "V", 0x89, 2, 3, -1, -1, -1, -1 },
    { NULL, "LSMSimiProperty;", 0x89, 4, 5, -1, -1, -1, -1 },
    { NULL, "V", 0x89, 6, 7, -1, -1, -1, -1 },
    { NULL, "V", 0x9, 8, 9, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0xa, 10, 11, -1, -1, -1, -1 },
    { NULL, "V", 0xa, 12, 13, -1, -1, -1, -1 },
    { NULL, "LSMSimiProperty;", 0xa, 14, 11, -1, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0xa, 15, 16, -1, 17, -1, -1 },
  ...
  methods[1].selector = @selector(setDebugModeWithBoolean:withSMDebugger_DebuggerInterface:);
  methods[2].selector = @selector(load__WithNSStringArray:);
  methods[3].selector = @selector(evalWithNSString:withNSString:withSMSimiPropertyArray:);
  methods[4].selector = @selector(evalAsyncWithSMActiveSimi_Callback:withNSString:withNSString:withSMSimiPropertyArray:);
  methods[5].selector = @selector(setImportResolverWithSMActiveSimi_ImportResolver:);
  methods[6].selector = @selector(readFileWithNSString:);
  methods[7].selector = @selector(runWithNSString:withBoolean:);
  methods[8].selector = @selector(runExpressionWithNSString:);
  methods[9].selector = @selector(scanImportsWithJavaUtilList:withJavaUtilMap:);
  methods[10].selector = @selector(getObjectClass);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "FILE_ACTIVE_SIMI", "LNSString;", .constantValue.asLong = 0, 0x1a, -1, 18, -1, -1 },
    { "interpreter", "LSMInterpreter;", .constantValue.asLong = 0, 0xa, -1, 19, -1, -1 },
    { "debugger", "LSMDebugger;", .constantValue.asLong = 0, 0xa, -1, 20, -1, -1 },
    { "hadError", "Z", .constantValue.asLong = 0, 0x8, -1, 21, -1, -1 },
    { "hadRuntimeError", "Z", .constantValue.asLong = 0, 0x8, -1, 22, -1, -1 },
    { "importResolver", "LSMActiveSimi_ImportResolver;", .constantValue.asLong = 0, 0xa, -1, 23, -1, -1 },
    { "resolvedImports", "LJavaUtilList;", .constantValue.asLong = 0, 0xa, -1, 24, 25, -1 },
    { "WATCHER", "LSMErrorWatcher;", .constantValue.asLong = 0, 0x1a, -1, 26, -1, -1 },
  };
  static const void *ptrTable[] = { "setDebugMode", "ZLSMDebugger_DebuggerInterface;", "load", "[LNSString;", "eval", "LNSString;LNSString;[LSMSimiProperty;", "evalAsync", "LSMActiveSimi_Callback;LNSString;LNSString;[LSMSimiProperty;", "setImportResolver", "LSMActiveSimi_ImportResolver;", "readFile", "LNSString;", "run", "LNSString;Z", "runExpression", "scanImports", "LJavaUtilList;LJavaUtilMap;", "(Ljava/util/List<LToken;>;Ljava/util/Map<Ljava/lang/String;LNativeModulesManager;>;)Ljava/util/List<LToken;>;", &SMActiveSimi_FILE_ACTIVE_SIMI, &SMActiveSimi_interpreter, &SMActiveSimi_debugger, &SMActiveSimi_hadError, &SMActiveSimi_hadRuntimeError, &SMActiveSimi_importResolver, &SMActiveSimi_resolvedImports, "Ljava/util/List<Ljava/lang/String;>;", &SMActiveSimi_WATCHER, "LSMActiveSimi_ImportResolver;LSMActiveSimi_Callback;" };
  static const J2ObjcClassInfo _SMActiveSimi = { "ActiveSimi", "net.globulus.simi", ptrTable, methods, fields, 7, 0x1, 11, 8, -1, 27, -1, -1, -1 };
  return &_SMActiveSimi;
}

+ (void)initialize {
  if (self == [SMActiveSimi class]) {
    SMActiveSimi_resolvedImports = new_JavaUtilArrayList_init();
...
void SMActiveSimi_setDebugModeWithBoolean_withSMDebugger_DebuggerInterface_(jboolean debug, id<SMDebugger_DebuggerInterface> debuggerInterface) {
  SMActiveSimi_initialize();
  if (debug) {
    SMActiveSimi_debugger = new_SMDebugger_initWithSMDebugger_DebuggerInterface_(debuggerInterface);
  }
  else {
    SMActiveSimi_debugger = nil;
  }
}
...
void SMActiveSimi_load__WithNSStringArray_(IOSObjectArray *files) {
  ...
  SMActiveSimi_runWithNSString_withBoolean_([source description], true);
}
...
void SMActiveSimi_runWithNSString_withBoolean_(NSString *source, jboolean isLoad) {
  SMActiveSimi_initialize();
  ...
  if (SMActiveSimi_interpreter == nil) {
    ...
    SMActiveSimi_interpreter = new_SMInterpreter_initWithJavaUtilCollection_withSMDebugger_([nativeModulesManagers values], SMActiveSimi_debugger);
    [((SMErrorHub *) nil_chk(SMErrorHub_sharedInstance())) setInterpreterWithSMBlockInterpreter:SMActiveSimi_interpreter];
  }
  else {
    for (id<SMNativeModulesManager> __strong manager in nil_chk(SMActiveSimi_interpreter->nativeModulesManagers_)) {
      if ([manager isKindOfClass:[SMJavaNativeModulesManager class]]) {
        (void) [nativeModulesManagers putWithId:@"jar" withId:manager];
      }
      else if ([manager isKindOfClass:[SMCocoaNativeModulesManager class]]) {
        (void) [nativeModulesManagers putWithId:@"framework" withId:manager];
      }
    }
  }
  SMScanner *scanner = new_SMScanner_initWithNSString_withNSString_withSMDebugger_(SMActiveSimi_FILE_ACTIVE_SIMI, source, SMActiveSimi_debugger);
  id<JavaUtilList> tokens = SMActiveSimi_scanImportsWithJavaUtilList_withJavaUtilMap_([scanner scanTokensWithBoolean:true], nativeModulesManagers);
  SMParser *parser = new_SMParser_initWithJavaUtilList_withSMDebugger_(tokens, SMActiveSimi_debugger);
  ...
  if (SMActiveSimi_hadError) return;
  (void) [((SMInterpreter *) nil_chk(SMActiveSimi_interpreter)) interpretWithJavaUtilList:statements withBoolean:isLoad];
}

id<SMSimiProperty> SMActiveSimi_runExpressionWithNSString_(NSString *expression) {
  SMActiveSimi_initialize();
  id<JavaUtilList> tokens = [new_SMScanner_initWithNSString_withNSString_withSMDebugger_(SMActiveSimi_FILE_ACTIVE_SIMI, expression, SMActiveSimi_debugger) scanTokensWithBoolean:true];
  id<JavaUtilList> statements = [new_SMParser_initWithJavaUtilList_withSMDebugger_(tokens, SMActiveSimi_debugger) parse];
  return [((SMInterpreter *) nil_chk(SMActiveSimi_interpreter)) interpretWithJavaUtilList:statements];
}

id<JavaUtilList> SMActiveSimi_scanImportsWithJavaUtilList_withJavaUtilMap_(id<JavaUtilList> input, id<JavaUtilMap> nativeModulesManagers) {
  SMActiveSimi_initialize();
  ...
  for (jint i = 0; i < len; i++) {
    ...
    if ([((id<JavaUtilList>) nil_chk(SMActiveSimi_resolvedImports)) containsWithId:location]) {
      continue;
    }
    [((id<JavaUtilList>) nil_chk(SMActiveSimi_resolvedImports)) addWithId:location];
    NSString *pathString = [((NSString *) nil_chk(location)) lowercaseString];
    if ([((NSString *) nil_chk(pathString)) java_hasSuffix:@".simi"]) {
      id<JavaUtilList> tokens = [new_SMScanner_initWithNSString_withNSString_withSMDebugger_(pathString, SMActiveSimi_readFileWithNSString_(location), SMActiveSimi_debugger) scanTokensWithBoolean:false];
      [result addAllWithJavaUtilCollection:SMActiveSimi_scanImportsWithJavaUtilList_withJavaUtilMap_(tokens, nativeModulesManagers)];
    }
    else if (nativeModulesManagers != nil) {
//      NSString *extension = [pathString java_substring:[pathString java_lastIndexOf:'.'] + 1];
//      id<SMNativeModulesManager> manager = [nativeModulesManagers getWithId:extension];
//      if (manager != nil) {
//        [manager load__WithNSString:[((JavaNetURL *) nil_chk([((id<SMActiveSimi_ImportResolver>) nil_chk(SMActiveSimi_importResolver)) resolveWithNSString:pathString])) description] withBoolean:[((id<SMActiveSimi_ImportResolver>) nil_chk(SMActiveSimi_importResolver)) useApiClassNameWithNSString:pathString]];
//      }
    }
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "report", "LNSString;ILNSString;LNSString;", "runtimeError", "LSMRuntimeError;", "LSMActiveSimi;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LJavaNetURL;", 0x401, 2, 1, -1, -1, -1, -1 },
  ...
  methods[1].selector = @selector(resolveWithNSString:);
  methods[2].selector = @selector(useApiClassNameWithNSString:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "readFile", "LNSString;", "resolve", "useApiClassName", "LSMActiveSimi;" };
  static const J2ObjcClassInfo _SMActiveSimi_ImportResolver = { "ImportResolver", "net.globulus.simi", ptrTable, methods, NULL, 7, 0x609, 3, 0, 4, -1, -1, -1, -1 };
